...
/** 
    ...
    ****Note - for Ar3na we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of ar3na coming in to a transaction
