...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ar3na Core ar3na-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ar3na-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ar3na transaction") + "\n" +
                               "  ar3na-tx [options] -create [commands]   " + _("Create hex-encoded ar3na transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ar3na transaction
