                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ar3na Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AR3NA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ar3na: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ar3na Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ar3na Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ar3na"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AR3NA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AR3NA addresses"));
    ...
    openAction->setStatusTip(tr("Open a ar3na: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ar3na Core help message to get a list with possible Ar3na command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ar3na Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ar3na network", "", count));
}
...
{
    QString strTitle = tr("Ar3na Core"); // default title
