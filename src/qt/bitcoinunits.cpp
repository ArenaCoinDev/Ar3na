...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mAR3NA:
            return QString("mAR3NA");
        case uAR3NA:
            return QString::fromUtf8("μAR3NA");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case AR3NA:
            return QString("tAR3NA");
        case mAR3NA:
            return QString("mtAR3NA");
        case uAR3NA:
            return QString::fromUtf8("μtAR3NA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case AR3NA:
            return QString("AR3NA");
        case mAR3NA:
            return QString("Milli-AR3NA (1 / 1" THIN_SP_UTF8 "000)");
        case uAR3NA:
            return QString("Micro-AR3NA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case AR3NA:
            return QString("TestAR3NAs");
        case mAR3NA:
            return QString("Milli-TestAR3NA (1 / 1" THIN_SP_UTF8 "000)");
        case uAR3NA:
            return QString("Micro-TestAR3NA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
