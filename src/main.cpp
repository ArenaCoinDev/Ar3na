...
#if defined(NDEBUG)
#error "Ar3na cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uar3na) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // AR3NA: We use certain sporks during IBD, so check to see if they are
