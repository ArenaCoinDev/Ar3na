...
This mechanism has been integrated into Bitcore-Node-Arena which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/arena/insight-api-arena#web-socket-api](https://github.com/arena/insight-api-arena#web-socket-api)
* API: [https://github.com/arena/insight-api-arena#swifttx-transactions](https://github.com/arena/insight-api-arena#swifttx-transactions)
...
By default, the Bitcoin Green Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitcoin Green Core daemon:
