...
In order to support loading of multiple wallets in ar3na-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ar3na.cpp.
...
Changes to ar3na.cpp
----------------------
ar3na.cpp is the entry point into ar3na-qt, and as such, will require some minor modifications to provide hooks for
