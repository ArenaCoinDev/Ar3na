...
In order to support loading of multiple wallets in arena-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is arena.cpp.
...
Changes to arena.cpp
----------------------
arena.cpp is the entry point into arena-qt, and as such, will require some minor modifications to provide hooks for
