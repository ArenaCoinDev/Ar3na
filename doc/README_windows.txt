...
Intro
-----
Ar3na (AR3NA) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Ar3na utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ar3na-qt.exe.

Ar3na Core is the original Ar3na client and it builds the backbone of the network.
However, it downloads and stores the entire history of Ar3na transactions;
