...
Intro
-----
Arena (AR3NA) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Arena utilizes an energy efficient proof-of-stake algorithm, 
...
Arena Core is the original Arena client and it builds the backbone of the network.
However, it downloads and stores the entire history of Arena transactions;
