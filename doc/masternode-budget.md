...
Bitcoin Green now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<arena_address\> \<monthly_payment_arena\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ AR3NA, _12_ times over the course of a year totaling _24000_ AR3NA.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<arena_address\> \<monthly_payment_arena\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` AR3NA.
 ...
 * vote-many          - Vote on a Bitcoin Green initiative
 * vote-alias         - Vote on a Bitcoin Green initiative
 * vote               - Vote on a Bitcoin Green initiative/budget
