...
Ar3na now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ar3na_address\> \<monthly_payment_ar3na\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ar3na_address\> \<monthly_payment_ar3na\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a Ar3na initiative
 * vote-alias         - Vote on a Ar3na initiative
 * vote               - Vote on a Ar3na initiative/budget
