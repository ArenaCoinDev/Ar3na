...
Arena now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
 ...
 * vote-many          - Vote on a Arena initiative
 * vote-alias         - Vote on a Arena initiative
 * vote               - Vote on a Arena initiative/budget
