...
#   c) node1 mines 32 blocks, so now node 0 has 500000AR3NA, node 1 has 4250AR3NA, node2 has none.
#   d) node0 sends 601 AR3NA to node2, in two transactions (301 AR3NA, then 300 AR3NA).
