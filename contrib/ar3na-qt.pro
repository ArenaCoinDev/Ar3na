...
RESOURCES += src/qt/ar3na.qrc src/qt/ar3na_locale.qrc

TRANSLATIONS += src/qt/locale/ar3na_bg.ts \
                src/qt/locale/ar3na_de.ts \
                src/qt/locale/ar3na_en.ts \
                src/qt/locale/ar3na_es.ts \
                src/qt/locale/ar3na_fi.ts \
                src/qt/locale/ar3na_fr.ts \
                src/qt/locale/ar3na_it.ts \
                src/qt/locale/ar3na_ja.ts \
                src/qt/locale/ar3na_pl.ts \
                src/qt/locale/ar3na_pt.ts \
                src/qt/locale/ar3na_ru.ts \
                src/qt/locale/ar3na_sk.ts \
                src/qt/locale/ar3na_sv.ts \
                src/qt/locale/ar3na_vi.ts \
                src/qt/locale/ar3na_zh_CN.ts \
                src/qt/locale/ar3na_zh_TW.ts
