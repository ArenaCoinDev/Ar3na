...
This means one can have an always-on arenad instance running, and another local arenad/arena-qt instance which connects to this node and receives blocks from it.
