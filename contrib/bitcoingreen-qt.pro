...
RESOURCES += src/qt/arena.qrc src/qt/arena_locale.qrc

TRANSLATIONS += src/qt/locale/arena_bg.ts \
                src/qt/locale/arena_de.ts \
                src/qt/locale/arena_en.ts \
                src/qt/locale/arena_es.ts \
                src/qt/locale/arena_fi.ts \
                src/qt/locale/arena_fr.ts \
                src/qt/locale/arena_it.ts \
                src/qt/locale/arena_ja.ts \
                src/qt/locale/arena_pl.ts \
                src/qt/locale/arena_pt.ts \
                src/qt/locale/arena_ru.ts \
                src/qt/locale/arena_sk.ts \
                src/qt/locale/arena_sv.ts \
                src/qt/locale/arena_vi.ts \
                src/qt/locale/arena_zh_CN.ts \
                src/qt/locale/arena_zh_TW.ts
