Contributing to Arena Core
==================================

The Arena Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Arena Core project, and is not to be
confused with overall Arena Network Protocol consensus changes.

Whether a pull request is merged into Arena Core rests with the project merge
...
Patches that change Arena consensus rules are considerably more involved than
...
Where a patch set proposes to change the Arena consensus, it must have been
...
The project leader is the release manager for each Arena Core release.
