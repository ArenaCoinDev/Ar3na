Contributing to Bitcoin Green Core
==================================

The Bitcoin Green Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitcoin Green Core project, and is not to be
confused with overall Bitcoin Green Network Protocol consensus changes.

Whether a pull request is merged into Bitcoin Green Core rests with the project merge
...
Patches that change Bitcoin Green consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitcoin Green consensus, it must have been
...
The project leader is the release manager for each Bitcoin Green Core release.
