Contributing to Ar3na Core
==================================

The Ar3na Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ar3na Core project, and is not to be
confused with overall Ar3na Network Protocol consensus changes.

Whether a pull request is merged into Ar3na Core rests with the project merge
...
Patches that change Ar3na consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ar3na consensus, it must have been
...
The project leader is the release manager for each Ar3na Core release.
